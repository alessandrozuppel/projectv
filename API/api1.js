...
const start = async () => {
  try {
    await fastify.listen("127.0.0.10:3001")                                                    //Creo web server e sto in ascolto sulla porta 3000
    fastify.log.info(`server listening on 127.0.0.10:3001`)      // Ascolto tutte richiest http
  } catch (err) {
